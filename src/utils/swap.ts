...
export class SwapUtils {
   ...
   * @parm a2b - true if the swap is A to B, false if the swap is B to A.
   * @returns The default sqrt price limit for the swap.
   */
  static getDefaultSqrtPriceLimit(a2b: boolean) {
   ...
   */
  static getDefaultOtherAmountThreshold(amountSpecifiedIsInput: boolean) {
   ...
   * @param a2b - The direction of the trade.
